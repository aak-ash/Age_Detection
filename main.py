...
age=AgeDataSet('/home/aakash/Desktop/DL-Models/CNN/Train_Age/Train/train.csv','/home/aakash/Desktop/DL-Models/CNN/Train_Age/Train/',transform=transform)
...
print('Accuracy of the network on the  test images: %0.6f %%' % (100 * correct / total))